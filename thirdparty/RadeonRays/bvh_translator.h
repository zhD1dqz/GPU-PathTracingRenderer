...
namespace RadeonRays
{
    ...
    public:
        ...
        void ProcessBLAS();
        void ProcessTLAS();
        void UpdateTLAS(const Bvh* topLevelBvh, const std::vector<PathTraceAlg::MeshInstance>& instances);
        void Process(const Bvh* topLevelBvh, const std::vector<PathTraceAlg::Mesh*>& meshes, const std::vector<PathTraceAlg::MeshInstance>& instances);
        int topLevelIndex = 0;
    ...
    private:
        ...
        std::vector<PathTraceAlg::MeshInstance> meshInstances;
        std::vector<PathTraceAlg::Mesh*> meshes;
